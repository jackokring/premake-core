...
ifneq (,$(lua_lib_config))
	...
	@${MAKE} --no-print-directory -C contrib/lua -f Makefile config=$(lua_lib_config)
endif

luashim-lib:
ifneq (,$(luashim_lib_config))
	@echo "==== Building luashim-lib ($(luashim_lib_config)) ===="
	@${MAKE} --no-print-directory -C contrib/luashim -f Makefile config=$(luashim_lib_config)
endif

zlib-lib:
ifneq (,$(zlib_lib_config))
	@echo "==== Building zlib-lib ($(zlib_lib_config)) ===="
	@${MAKE} --no-print-directory -C contrib/zlib -f Makefile config=$(zlib_lib_config)
endif

zip-lib:
ifneq (,$(zip_lib_config))
	@echo "==== Building zip-lib ($(zip_lib_config)) ===="
	@${MAKE} --no-print-directory -C contrib/libzip -f Makefile config=$(zip_lib_config)
endif

mbedtls-lib:
ifneq (,$(mbedtls_lib_config))
	@echo "==== Building mbedtls-lib ($(mbedtls_lib_config)) ===="
	@${MAKE} --no-print-directory -C contrib/mbedtls -f Makefile config=$(mbedtls_lib_config)
endif

curl-lib:
ifneq (,$(curl_lib_config))
	@echo "==== Building curl-lib ($(curl_lib_config)) ===="
	@${MAKE} --no-print-directory -C contrib/curl -f Makefile config=$(curl_lib_config)
endif

example: luashim-lib
ifneq (,$(example_config))
	@echo "==== Building example ($(example_config)) ===="
	@${MAKE} --no-print-directory -C binmodules/example -f Makefile config=$(example_config)
endif

luasocket: luashim-lib
ifneq (,$(luasocket_config))
	@echo "==== Building luasocket ($(luasocket_config)) ===="
	@${MAKE} --no-print-directory -C binmodules/luasocket -f Makefile config=$(luasocket_config)
endif

clean:
	@${MAKE} --no-print-directory -C . -f Premake5.make clean
	@${MAKE} --no-print-directory -C contrib/lua -f Makefile clean
	@${MAKE} --no-print-directory -C contrib/luashim -f Makefile clean
	@${MAKE} --no-print-directory -C contrib/zlib -f Makefile clean
	@${MAKE} --no-print-directory -C contrib/libzip -f Makefile clean
	@${MAKE} --no-print-directory -C contrib/mbedtls -f Makefile clean
	@${MAKE} --no-print-directory -C contrib/curl -f Makefile clean
	@${MAKE} --no-print-directory -C binmodules/example -f Makefile clean
	@${MAKE} --no-print-directory -C binmodules/luasocket -f Makefile clean
